package app.linuxdeploy.fragment;
...
import app.linuxdeploy.RemoveEnvTask;
import app.linuxdeploy.UpdateEnvTask;
import app.linuxdeploy.receiver.BootReceiver;
...
public class SettingsFragment extends PreferenceFragmentCompat implements
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        switch (key) {
            ...
            case "stealth":
                // set stealth mode
                // Run app without launcher: am start -n app.linuxdeploy/.MainActivity
